...
import { mockSwitches } from "@/shared/seed/switch";
...
export default function SwitchPage() {
  ...
  const handleCreate = () => {
    console.log("Create new switch");
  };

  return (
    <div className="container mx-auto py-6">
      <TableTemplate
        title="Manage Keyboard Switches"
        columns={productColumns}
        data={data}
        filterConfigs={filterConfigs}
        onCreateNew={handleCreate}
        createButtonLabel="Thêm switch"
      />
    </div>
  );
}
